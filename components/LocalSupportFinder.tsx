      ...
      <div className="bg-zinc-900 rounded-[3rem] p-10 md:p-16 text-white border border-zinc-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic leading-none">Find Local Expertise</h2>
            <p className="text-zinc-400 text-sm md:text-lg italic font-medium max-w-xl">
              Connect with vetted immigration specialists and legal advisors in your current city.
            </p>
          </div>
          ...
          {!results ? (
            <button 
              ...
              disabled={loading}
              className="px-10 py-5 bg-white text-zinc-900 font-black rounded-2xl uppercase tracking-widest text-[11px] hover:bg-zinc-100 transition-all flex items-center gap-4 disabled:opacity-50"
            >
              {loading ? (
                <>
                ...
                {results.grounding.map((chunk: any, i: number) => {
                  ...
                  return (
                    <a 
                      ...
                      className="p-5 bg-white rounded-2xl flex flex-col gap-2 hover:scale-[1.02] transition-transform shadow-lg"
                    >
                      <span className="text-zinc-900 font-black text-xs uppercase tracking-tight truncate">
                        {chunk.maps.title || "Local Advisor"}
                      </span>

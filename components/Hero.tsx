  ...
  return (
    <section className="bg-white min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-4 md:px-6 py-10 md:py-20 text-center animate-fade-in relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-10">
        <div className="flex -space-x-3" aria-label="Successful applicants">
          {[1,2,3,4].map(i => (
        ...
        <div className="flex flex-col items-start ml-1">
          ...
          <span className="text-[9px] font-black uppercase tracking-widest text-zinc-400">4.9/5 RATING (500+ VERIFIED ENDORSEMENTS)</span>
        </div>
      </div>
      ...
      <div className="inline-flex items-center px-6 py-2.5 bg-white border border-amber-100 rounded-full text-amber-600 text-[11px] font-black uppercase tracking-[0.2em] mb-10 shadow-sm italic ring-4 ring-amber-50/50">
        <i className="fas fa-bolt-lightning mr-2 text-amber-500 animate-pulse"></i> 2025 UK IMMIGRATION GUIDELINES
      </div>
      
      {/* Headline - Primary SEO H1 */}
      <h1 className="text-[40px] md:text-[88px] font-black text-[#121212] max-w-6xl leading-[0.95] md:leading-[0.85] mb-10 tracking-tighter uppercase italic">
        UK GLOBAL TALENT VISA <br/>
        <span className="text-[#C4A030] drop-shadow-sm">AI ELIGIBILITY AUDIT</span> <br/>
        & ASSESSMENT
      </h1>
      ...
      <h2 className="text-zinc-400 text-sm md:text-[22px] max-w-3xl mx-auto leading-relaxed mb-14 font-medium italic px-4">
        The definitive professional assessment tool for UK Global Talent Visa readiness. Map your evidence for Tech Nation, Arts Council, and Royal Academy endorsements in under 5 minutes.
      </h2>
      ...
      <div className="flex flex-col items-center w-full px-4 gap-8">
        ...
        <nav className="flex flex-wrap justify-center gap-6 opacity-40">
           <span className="text-[9px] font-black uppercase tracking-widest">Digital Technology</span>
           <span className="text-[9px] font-black uppercase tracking-widest">Arts & Culture</span>
           <span className="text-[9px] font-black uppercase tracking-widest">Fashion Design</span>

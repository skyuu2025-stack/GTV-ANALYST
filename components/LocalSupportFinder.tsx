...
const LocalSupportFinder: React.FC = () => {
  ...
  return (
    <section className="py-24 px-6 max-w-4xl mx-auto" id="local-support" itemscope itemtype="https://schema.org/LocalBusiness">
      <div className="bg-zinc-900 rounded-[3rem] p-10 md:p-16 text-white border border-zinc-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase italic leading-none" itemprop="name">Find UK Visa Consultants Near You</h2>
            <p className="text-zinc-400 text-sm md:text-lg italic font-medium max-w-xl" itemprop="description">
              Our advanced GEO-engine maps your current location to the top-rated UK Global Talent Visa consultants, immigration solicitors, and professional talent networks.
            </p>
          </div>
          ...
          {!results ? (
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {results.grounding.map((chunk: any, i: number) => {
                  ...
                  return (
                    ...
                    >
                      <span className="text-zinc-900 font-black text-xs uppercase tracking-tight truncate group-hover:text-amber-600 transition-colors" itemprop="name">
                        {chunk.maps.title || "Visa Advisor"}
                      </span>
                      <div className="flex items-center gap-2">
                        <i className="fas fa-map-marker-alt text-amber-500 text-[10px]"></i>
                        <span className="text-zinc-400 text-[9px] font-bold uppercase tracking-widest">View on Google Maps</span>
                      </div>
                    </a>
                  );
                })}
              ...
              <button onClick={() => setResults(null)} className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.2em] hover:text-white transition-colors">New Search</button>
            </div>
          )}
      ...
      <div className="mt-8 text-center">
         <p className="text-[9px] text-zinc-300 font-black uppercase tracking-widest">Global Talent Support Hubs: London, San Francisco, Bangalore, Dubai, Manchester, New York</p>
      </div>
    </section>
  );
};
